...
const getDirection = (coordinates, offset) => {
...
const TinderCard = React.forwardRef(({ flickOnSwipe = true, children, onSwipe, onMove, onCardLeftScreen, className, preventSwipe = [] }, ref) => {
